...
<link href="<?php echo static_url('templates/metronics/assets/global/plugins/jqvmap/jqvmap/jqvmap.css');?>" rel="stylesheet" type="text/css"/>
...
<!-- BEGIN PAGE STYLES -->
<link href="<?php echo static_url('templates/metronics/assets/admin/pages/css/tasks.css');?>" rel="stylesheet" type="text/css"/>
<!-- END PAGE STYLES -->
<!-- BEGIN THEME STYLES -->
<!-- DOC: To use 'rounded corners' style just load 'components-rounded.css' stylesheet instead of 'components.css' in the below style tag -->
<link href="<?php echo static_url('templates/metronics/assets/global/css/components-rounded.css');?>" id="style_components" rel="stylesheet" type="text/css"/>
<link href="<?php echo static_url('templates/metronics/assets/global/css/plugins.css');?>" rel="stylesheet" type="text/css"/>
<link href="<?php echo static_url('templates/metronics/assets/admin/layout4/css/layout.css');?>" rel="stylesheet" type="text/css"/>
<link href="<?php echo static_url('templates/metronics/assets/admin/layout4/css/themes/light.css');?>" rel="stylesheet" type="text/css" id="style_color"/>
<link href="<?php echo static_url('templates/metronics/assets/admin/layout4/css/custom.css');?>" rel="stylesheet" type="text/css"/>
<!-- END THEME STYLES -->