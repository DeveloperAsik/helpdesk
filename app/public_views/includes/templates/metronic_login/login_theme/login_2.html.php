...
<div class="logo">
    <a href="index.html">
        <img src="<?php echo static_url('templates/metronics/assets/pages/img/logo-big-white.png') ?>" style="height: 17px;" alt="" /> </a>
</div>
<!-- END LOGO -->
<!-- BEGIN LOGIN -->
<div class="content">
...
<div class="copyright hide"> <?php echo isset($_ajax_var_configs->copyright) ? $_ajax_var_configs->copyright : '';?> </div>