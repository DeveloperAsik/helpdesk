...
<div class="user-login-5">
    <div class="row bs-reset">
        <div class="col-md-6 login-container bs-reset">
            <img class="login-logo login-6" src="<?php echo static_url('templates/metronics/assets/pages/img/login/login-invert.png') ?>" />
                ...
                <form action="javascript:;" class="login-form">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-8 text-right">
                            ...
                            <button class="btn blue" type="button">Sign In</button>
                        </div>
                    </div>
                </form>
            </div>
