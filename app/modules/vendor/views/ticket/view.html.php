<div class="row">
    ...
    <div class="col-md-12" id="trf" hidden>
        <div class="portlet box green">
            <div class="portlet-title">
                <div class="caption">
                    <i class="fa fa-exchange"></i><?php echo $this->lang->line('global_ticket_transfer'); ?>
                </div>
                <div class="tools">
            ...
            <div class="portlet-body">
                <ul class="nav nav-tabs">
                    <li class="active">
                        <a href="#tab_1_1" data-toggle="tab"><?php echo $this->lang->line('global_ticket_transfer_in'); ?> <span class="trf_in"></span></a>
                    </li>
                    <li>
                        <a href="#tab_1_2" data-toggle="tab"><?php echo $this->lang->line('global_ticket_transfer_out'); ?> <span class="trf_out"></span></a>
                    </li>
                </ul>
                    ...
                    <div class="tab-pane fade active in" id="tab_1_1"> 
                        ...
                        <div class="portlet light portlet-fit portlet-datatable bordered">
                            <div class="portlet-title">
                                <div class="caption">
                                    <i class="fa fa-list-alt font-dark"></i>
                                    <span class="caption-subject font-dark bold uppercase"><?php echo $this->lang->line('global_ticket_list'); ?> transfer In</span>
                                </div>
                            </div>
                            <div class="portlet-body">
                                <div class="table-container">
                                    <table class="table table-bordered table-checkable" id="trf_in">
                                        <thead>
                                            <tr role="row" class="heading">
                                                <th width="5%"> # </th>
                                                <th width="5%">Info</th>
                    ...
                    <div class="tab-pane fade" id="tab_1_2"> 
                        ...
                        <div class="portlet light portlet-fit portlet-datatable bordered">
                            <div class="portlet-title">
                                <div class="caption">
                                    <i class="fa fa-list-alt font-dark"></i>
                                    <span class="caption-subject font-dark bold uppercase"><?php echo $this->lang->line('global_ticket_list'); ?> transfer Out</span>
                                </div>
                                <!--<div class="actions">
                                    <div class="btn-group">
                                        <a style="font-size:10px; text-align:center" title="Refresh" class="btn dark btn-outline sbold col-ms-2" data-value="refresh" data-id="refresh" id="opt_refresh2">
                            ...
                            <div class="portlet-body">
                                <div class="table-container">
                                    <table class="table table-bordered table-checkable" id="trf_out">
                                        <thead>
                                            <tr role="row" class="heading">
                                                <th width="5%"> # </th>
                                                <th width="5%">Info</th>
