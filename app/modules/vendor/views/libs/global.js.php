<script>
    ...
    var fnCheckResponseBtn = function (id) { var return_val = false; var url_post = base_url + 'vendor/ticket/check_status_ticket'; var formdata = { id: id }; $.ajax({ url: url_post, method: "POST", data: formdata, success: function (response) { if (response == 'true') { return true; } else { return false; } } }); };
    var fnGetTimtikUser = function () { var url_post = base_url + 'vendor/user/get_user/1'; $.ajax({ url: url_post, method: "POST", success: function (response) { $('.timtik').html(response); } }); return false; };
    var fnGetVendorUser = function () { var url_post = base_url + 'vendor/user/get_user/2'; $.ajax({ url: url_post, method: "POST", success: function (response) { $('.vendor').html(response); } }); return false; };
    ...
    var fnCloseTicket = function () {
        ...
        if (id) {
            ...
            $.ajax({url: base_url + 'vendor/ticket/set_close/', method: "POST", data: formdata, success: function (response) {
                    return false;
                }, error: function (response) {
                    return false;
                }});
    ...
    var sendFile = function (file, that, opt) {
        ...
        $.ajax({
            data: data,
            type: 'post',
            url: base_url + 'vendor/tracking/insert_image_summernote/' + opt.ticket_id + '/' + opt.code,
            cache: false,
            contentType: false,
            processData: false,
    ...
    var fnSetOpenTicket = function (formdata) {
        $.ajax({
            url: base_url + 'vendor/ticket/set_open/',
            method: "POST",
            data: formdata,
            success: function (response) {
    ...
    var fnCloseTicket = function (formdata) {
        ...
        $.ajax({
            url: base_url + 'vendor/ticket/set_close/',
            method: "POST",
            data: formdata,
            success: function (response) {
                console.log(response);
    ...
    var fnGetDetail = function (id) {
        ...
        $.ajax({
            url: base_url + 'vendor/ticket/get_ticket_detail/',
            method: "POST",
            data: formdata,
            beforeSend: function () {
                // Statement
    ...
    var fnCheckTicketOpenStatus = function (id) {
        ...
        $.ajax({
            url: base_url + 'vendor/ticket/check_status_ticket/',
            method: "POST",
            data: formdata,
            success: function (data) {
                if (data == 'false') {
    ...
    var fnCheckTicketTransfer = function(id){
        $.post( base_url + 'vendor/ticket/check_total_transfer_ticket/' + id, function( data ) {
            if(data == 'false'){
                $('.modal').modal('hide');
    ...
    var fnGetTransferTicket = function (id) {
        ...
        $.ajax({
            url: base_url + 'vendor/ticket/get_data/',
            method: "POST",
            data: formdata,
            beforeSend: function () {
                // Statement
    ...
    var fnGetResponseTicket = function (id) {
        ...
        $.ajax({
            url: base_url + 'vendor/ticket/get_ticket_detail/response',
            method: "POST",
            data: formdata,
            beforeSend: function () {
                // Statement
    ...
    var fnGetCloseTicket = function (ticket_id) {
        ...
        $.ajax({
            url: base_url + 'vendor/tracking/get_job_desc',
            method: "POST",
            data: formdata,
            beforeSend: function () {
                // Statement
    ...
    var fnGetCategory = function () {
        $.ajax({
            url: base_url + 'vendor/ticket/get_category/',
    ...
    var fnGetJob = function (id, v) {
        $.ajax({
            url: base_url + 'vendor/ticket/get_category/' + id + '/job',
            method: "POST", //First change type to method here
            success: function (response) {
                if (v == 2) {
        ...
        return {
            init: function () {
                ...
                $('#frmResponse').on('submit', function (e) {
                    e.preventDefault();
                    var uri = base_url + 'vendor/ticket/response_ticket';
                             ...
                             var dialog = bootbox.dialog({
                                 ...
                                 buttons: {
                                     ...
                                     danger: {
                                         ...
                                         className: "grey",
                                         callback: function () {
                                             window.location.href = base_url + 'vendor/ticket/view/progress';
                                         }
                                     }
                                 }
                             });
                             dialog.init(function () {
                                 ...
                                 var interval = setInterval(function () {
                                     ...
                                     if (counter == 3) {
                                         ...
                                         // $(window).unbind('beforeunload');
                                         // window.onbeforeunload = null;
                                         window.open(base_url + 'vendor/tracking/view/' + Base64.encode(ticket_code), '_blank');
                                         $('.modal').modal('hide');
                                         window.location.href = base_url + 'vendor/ticket/view/progress';
                                     }
                                     ;
                ...
                $('#opn_agreement_trans_tickt').on('click', function (e) {
                    e.preventDefault();
                    var uri = base_url + 'vendor/ticket/agreement_to_take_over_ticket';
                ...
                $('#frmTransfer').on('submit', function (e) {
                    var uri = base_url + 'vendor/user/transfer_ticket';
                    var formdata = {
                    ...
                    bootbox.confirm("Are you sure?", function (result) {
                        ...
                        $.ajax({
                            ...
                            success: function (response) {
                                ...
                                window.location = base_url + 'vendor/ticket/view/progress';
                            },
                            error: function (jqXHR, textStatus, errorThrown) {
                                App.stopPageLoading();
                ...
                $('#frmClose').on('submit', function (e) {
                    var uri = base_url + 'vendor/tracking/close_ticket_request';
                    arr = [];
                    ...
                    bootbox.confirm("Are you sure?", function (result) {
                        ...
                        $.ajax({
                            ...
                            success: function (response) {
                                App.stopPageLoading();
                                setTimeout(function () {
                                    window.location = base_url + 'vendor/ticket/view/close';
                                }, '3000');
                            },
                            error: function (jqXHR, textStatus, errorThrown) {
                                App.stopPageLoading();
