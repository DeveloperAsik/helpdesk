...
<div class="row">
    ...
    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
        <div class="dashboard-stat blue"  style="background-color: #5ccd18">
            ...
            <a  style="background-color: #5ccd18" class="more" href="<?php echo base_url('vendor/ticket/view/open'); ?>" target="__blank"> <?php echo $this->lang->line('global_view_more'); ?>
    ...
    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
        <div class="dashboard-stat red" style="background-color: #ffb136">
            ...
            <a style="background-color: #ffb136" class="more" href="<?php echo base_url('vendor/ticket/view/progress'); ?>" target="__blank"> <?php echo $this->lang->line('global_view_more'); ?>
                <i class="m-icon-swapright m-icon-white"></i>
            </a>
        </div>
    </div>
   <!--  <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
        <div class="dashboard-stat red">
            ...
            <a class="more" href="<?php echo base_url('vendor/ticket/view/transfer'); ?>" target="__blank"> <?php echo $this->lang->line('global_view_more'); ?>
                <i class="m-icon-swapright m-icon-white"></i>
            </a>
        </div>
    </div> -->
    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
        <div class="dashboard-stat green">
            ...
            <a class="more" href="<?php echo base_url('vendor/ticket/view/close'); ?>" target="__blank"> <?php echo $this->lang->line('global_view_more'); ?>
                <i class="m-icon-swapright m-icon-white"></i>
            </a>
        </div>
    </div>
