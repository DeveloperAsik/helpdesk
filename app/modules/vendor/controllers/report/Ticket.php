...
class Ticket extends MY_Controller {
    ...
    public function index() {
        redirect(base_url('vendor/report/ticket/by_category/'));
    }
            ...
            if (isset($res) && !empty($res) && $res != null) {
                ...
                if (isset($res) && !empty($res)) {
                    ...
                    foreach ($res as $d) {
                        ...
                        $data['action'] = '';
                        if ($param3 == true) {
                            $data['action'] = '<a href="' . base_url('vendor/report/ticket/generate/excel/' . $d['id']) . '" title="Download file to excel"><i class="fa fa-file-excel-o"></i></a>';
                        }
                        $arr[] = $data;
                        $i++;
                    }
