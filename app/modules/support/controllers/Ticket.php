...
class Ticket extends MY_Controller {
    ...
    public function index() {
        redirect(base_url('support/ticket/view/'));
    }
                    ...
                    if ($d['ticket_status'] == 'open') {
                        ...
                        if ((int) base64_decode($this->auth_config->user_id) == $d['response_by']) {
                            $action = '
                                ...
                                <a id="' . $d['id'] . '" class="btn red btn-outline sbold" data-toggle="modal" href="' . base_url('support/tracking/view/' . base64_encode($d['code'])) . '" title="Telusur" data-id="' . base64_encode($d['ticket_id']) . '"> <i class="fa fa-tripadvisor"></i> </a>
                            ';
                        } else {
                        ...
                        if ($key == 'transfer_in') {
                            $action = '
                        <a class="btn red btn-outline sbold" data-toggle="modal" href="#modal_detail" title="Detail" data-id="' . base64_encode($d['ticket_id']) . '"> <i class="fa fa-search-plus"></i> </a>
                        <a id="' . $d['id'] . '" class="btn red btn-outline sbold" data-toggle="modal" href="' . base_url('support/tracking/view/' . base64_encode($d['code'])) . '" title="Tracking" data-id="' . base64_encode($d['ticket_id']) . '"> <i class="fa fa-tripadvisor"></i> </a>
                        ';
                        } elseif ($key == 'transfer_out') {
                            $action = ' <a class="btn red btn-outline sbold" data-toggle="modal" href="#modal_detail" title="Detail" data-id="' . base64_encode($d['ticket_id']) . '"> <i class="fa fa-search-plus"></i> </a>';
                        } else {
