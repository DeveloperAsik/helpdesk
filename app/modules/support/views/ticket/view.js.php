        ...
        return {
            ...
            init: function () {
                $('input[type="checkbox"][name="insert_by"]').on('click', function () {
                    ...
                    if (id == true) {
                        $.post(base_url + 'support/user/get_issue_suggest/' + id, function (data) {
                ...
                if (key) {
                    if (key == 'transfer') {
                        ...
                        var table2 = $('#trf_in').DataTable({
                            ...
                            "ajax": {
                                url: base_url + 'support/ticket/get_list/transfer_in',
                                type: 'POST'
                            },
                            "columns": [
                                {"data": "num"},
                        ...
                        var table3 = $('#trf_out').DataTable({
                            ...
                            "ajax": {
                                url: base_url + 'support/ticket/get_list/transfer_out',
                                type: 'POST'
                            },
                            "columns": [
                                {"data": "num"},
                        ...
                        var table4 = $('#prog_def').DataTable({
                            ...
                            "ajax": {
                                url: base_url + 'support/ticket/get_list/progress',
                                type: 'POST'
                            },
                            "columns": [
                                {"data": "num"},
                        ...
                        var table5 = $('#prog_reopen').DataTable({
                            ...
                            "ajax": {
                                url: base_url + 'support/ticket/get_list/progress_reopen',
                                type: 'POST'
                            },
                            "columns": [
                                {"data": "num"},
                        ...
                        var table3 = $('#default').DataTable({
                            ...
                            "ajax": {
                                url: base_url + 'support/ticket/get_list/' + key,
                                type: 'POST'
                            },
                            "columns": [
                                {"data": "num"},
