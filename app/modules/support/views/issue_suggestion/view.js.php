        ...
        return {
            ...
            init: function () {
                var table = $('#datatable_ajax').DataTable({
                    ...
                    "serverSide": true,
                    "ajax": {
                        url: base_url + 'support/issue_suggestion/get_list/',
                        type: 'POST'
                    },
                    "columns": [
                        {"data": "rowcheck"},
                ...
                $('#datatable_ajax').on('switchChange.bootstrapSwitch', 'input[name="status"]', function (event, state) {
                    ...
                    $.ajax({
                        url: base_url + 'support/issue_suggestion/update_status/',
                ...
                $("#opt_edit").on('click', function () {
                    ...
                    if (status_ == 0) {
                        ...
                        $.post(base_url + 'support/issue_suggestion/get_data/' + id, function (data) {
                    ...
                    if (status_ == 0) {
                        bootbox.confirm("Are you sure to delete this id?", function (result) {
                            if (result == true) {
                                ...
                                $.ajax({
                                    url: base_url + 'support/issue_suggestion/delete/',
                                    method: "POST", //First change type to method here
                                    data: formdata,
                                    success: function (response) {
                                        toastr.success('Successfully ' + response);
                ...
                $("#sbmt_form").on('click', function () {
                    ...
                    var uri = base_url + 'support/issue_suggestion/insert/';
                    ...
                    if (id) {
                        uri = base_url + 'support/issue_suggestion/update/';
