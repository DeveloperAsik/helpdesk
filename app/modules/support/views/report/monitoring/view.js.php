<script>
    ...
    var fnTotalTicketPerMonth = function () {
        var uri = base_url + "support/report/monitoring/get_total_ticket_per_month";
        $.ajax({
            url: uri,
            type: "post",
    ...
    var fnTotalTicketPerMonthByStatus = function(){
        var uri = base_url + "support/report/monitoring/get_total_ticket_per_month_by_status";
        $.ajax({
            url: uri,
            type: "post",
            success: function (response) {
    ...
    var fnTotalTicketPerMonthByUser = function(){
        var uri = base_url + "support/report/monitoring/get_total_ticket_progress_per_month";
        $.ajax({
            url: uri,
            type: "post",
            success: function (response) {
