    ...
    public function get_list() {
        ...
        if (isset($post) && !empty($post)) {
            ...
            if (isset($post['param1']) && !empty($post['param1'])) {
                ...
                $jnt = 'LEFT JOIN (SELECT messages As response_message, ticket_id, min(create_date) FROM tbl_helpdesk_ticket_chats l WHERE is_vendor != 0 AND is_active = 1) AS l ON l.ticket_id = a.id';
           ...
           ' . $act . '
            ...
            if (isset($res) && !empty($res)) {
                ...
                $txt = '<table class="table" style="width:100%;">                         
                            <tr>
                                <th rowspan="3" style="width:15%;"><img src="' . $Logo2 . '" height="80" width="80" alt="logo-imigrasi"/></th>
                                <td style="width:70%;text-align:center; font-size:12">KEMENTERIAN HUKUM DAN HAM REPUBLIK INDONESIA</td>
                                <th rowspan="3" style="width:15%;"><img src="' . $Logo1 . '" height="80" width="80" alt="logo-pengayoman"/></th>
                            </tr>
                            <tr>
