 ...
 * @author SuperUser
 */
class V2_monitoring extends MY_Controller {
    ...
    public function index() {
        redirect(base_backend_url('reports/v2_monitoring/view/'));
    }
    ...
    public function get_list() {
        ...
        if (isset($post) && !empty($post)) {
            ...
            $config = array(
                'base_url' => base_backend_url('reports/v2_monitoring/get_list/'),
    ...
    public function get_total_ticket_per_kanim() {
        $this->load->model(array('Tbl_helpdesk_ticket_transactions', 'Tbl_helpdesk_imigration_branchs', 'Tbl_helpdesk_tickets'));
        $year = date('Y');
