...
class Admin extends MY_Controller {
    ...
    public function __construct() {
        parent::__construct();
        $this->load->model(array('Tbl_users', 'Tbl_helpdesk_timtik_users'));
    }
    ...
    public function get_list() {
        ...
        if (isset($post) && !empty($post)) {
            ...
            $total_rows = $this->Tbl_helpdesk_timtik_users->find('count', $cond_count);
            $res = $this->Tbl_helpdesk_timtik_users->find('all', $cond);
            $arr = array();
    ...
    public function update() {
        ...
        if (isset($post) && !empty($post)) {
            ...
            if ($res == true) {
                $timtik = $this->Tbl_helpdesk_timtik_users->find('first', array('conditions' => array('user_id' => $user_id)));
                $arr_timtik = array(
                    'nik' => $post['nik'],
                    'name' => $post['username'],
                    'email' => $post['email'],
                ...
                $this->Tbl_helpdesk_timtik_users->update($arr_timtik, $timtik['id']);
                echo 'success';
            } else {
                echo 'failed';
            }
        ...
        if (isset($post) && !empty($post)) {
            ...
            if (is_array($post['id'])) {
                ...
                foreach ($post['id'] AS $key => $val) {
                    ...
                    $timtik_user = $this->Tbl_helpdesk_timtik_users->find('first', array('conditions' => array('user_id' => $val)));
                    ...
                    if ($timtik_user != null) {
                        ...
                        $this->Tbl_helpdesk_timtik_users->delete($timtik_user['id']);
                    }
                }
                if ($arr_res == true) {
                    echo 'success';
                ...
                //find at tbl_helpdesk_timtik_users
                $timtik_user = $this->Tbl_helpdesk_timtik_users->find('first', array('conditions' => array('user_id' => $id)));
