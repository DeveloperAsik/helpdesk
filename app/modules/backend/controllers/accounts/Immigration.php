 ...
 * @author SuperUser
 */
class Immigration extends MY_Controller {
    ...
    public function index() {
        redirect(base_backend_url('accounts/immigration/view/'));
    }
    ...
    public function view() {
        ...
        $data['branchs'] = $this->Tbl_helpdesk_imigration_branchs->find('list', array('order' => array('key' => 'name', 'type' => 'ASC')));
    ...
    public function import_file() {
        if (isset($_FILES['import_file_kanim']) && !empty($_FILES['import_file_kanim'])) {
            ...
            $this->load->model(array('Tbl_users', 'Tbl_user_groups', 'Tbl_helpdesk_employees', 'Tbl_helpdesk_employee_users', 'Tbl_helpdesk_imigration_branchs'));
            if (isset($arr) && !empty($arr)) {
                foreach ($arr AS $k => $v) {
                    $branch = $this->Tbl_helpdesk_imigration_branchs->find('first', array('conditions' => array('code' => $v['office_id'])));
                    $pass = array();
    ...
    public function get_list() {
        ...
        if (isset($post) && !empty($post)) {
            ...
            $cond['joins'] = $cond_count['joins'] = array(
                ...
                array(
                    'table' => 'tbl_helpdesk_imigration_branchs c',
        ...
        if (isset($post) && !empty($post)) {
            $res = $this->Tbl_helpdesk_employees->find('first', array(
                ...
                'joins' => array(
                    ...
                    array(
                        'table' => 'tbl_helpdesk_imigration_branchs d',
