                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-icon right">
                                        <i class="fa fa-info-circle tooltips" data-container="body"></i>
                                        <input class="form-control" type="text" name="monitor" placeholder="monitor" readonly="" /> 
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="control-label"><?php echo $this->lang->line('global_branch_name'); ?></label>
                                    <select class="form-control" name="branch" id="branch">
                                        <option value="0"><?php echo $this->lang->line('global_select_other'); ?></option>
