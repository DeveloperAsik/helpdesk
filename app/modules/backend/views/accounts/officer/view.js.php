<script>
    ...
    var table = $('#datatable_ajax').DataTable({
        ...
        "ajax": {
            url: base_backend_url + 'accounts/officer/get_list/',
            type: 'POST'
        },
        "columns": [
            {"data": "rowcheck"},
        ...
        return {
            ...
            init: function () {
                ...
                $('#download_sample').on('click', function () {
                    ...
                    window.location = base_backend_url + 'accounts/officer/download_sample/' + filename + '/' + filetype;
                });
                $('#datatable_ajax').on('switchChange.bootstrapSwitch', 'input[name="status"]', function (event, state) {
                    bootbox.confirm("Are you sure?", function (result) {
                        ...
                        $.ajax({
                            url: base_backend_url + 'accounts/officer/update_status/',
                    ...
                    switch (action) {
                        ...
                        case 'edit':
                            ...
                            if (status_ == 0) {
                                ...
                                $.ajax({
                                    url: base_backend_url + 'accounts/officer/get_data/',
                                    method: "POST", //First change type to method here
                                    data: formdata,
                                    success: function (response) {
                        ...
                        case 'delete':
                            bootbox.confirm("Are you sure to delete this id?", function (result) {
                                ...
                                var uri = base_backend_url + 'accounts/officer/delete/';
                                id = [];
                ...
                $("#add_edit").on('submit', function (e) {
                    ...
                    var uri = base_backend_url + 'accounts/officer/insert/';
                    ...
                    if (id) {
                        uri = base_backend_url + 'accounts/officer/update/';
                        txt = 'update employee';
                        formdata = {
                            id: Base64.encode(id),
                            nik: $('input[name="nik"]').val(),
                ...
                $('#import_file').on('submit', function (e) {
                    ...
                    var uri = base_backend_url + 'accounts/officer/import_file/';
                    $.ajax({
                        url: uri,
                        method: "POST", //First change type to method here
                        data: formData,
