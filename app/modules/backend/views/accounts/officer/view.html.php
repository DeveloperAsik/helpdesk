        ...
        <div class="portlet light portlet-fit portlet-datatable bordered">
            <div class="portlet-title">
                ...
                <div class="actions actDatatables">
                    <div class="btn-group">
                        <a href="#import_user_office" style="font-size:10px; text-align:center" data-toggle="modal" title="Import User " class="btn dark btn-outline sbold col-ms-2" data-value="import" data-id="import" id="opt_import">
