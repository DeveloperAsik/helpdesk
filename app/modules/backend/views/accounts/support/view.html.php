        ...
        <div class="portlet light portlet-fit portlet-datatable bordered">
            <div class="portlet-title">
                ...
                <div class="actions actDatatables">
                    <div class="btn-group">
                        <a href="#import_user_support" style="font-size:10px; text-align:center" data-toggle="modal" title="Import User KSO (Vendor)" class="btn dark btn-outline sbold col-ms-2" data-value="import" data-id="import" id="opt_import">
            ...
            <div class="portlet-body">
                <ul class="nav nav-tabs">
                    <li class="active">
                        <a href="#tab_reversed_1_1" data-toggle="tab"><?php echo $this->lang->line('global_support_title'); ?>  </a>
                    </li>
                    <li>
                        <a href="#tab_reversed_1_2" data-toggle="tab"><?php echo $this->lang->line('global_support_user'); ?></a>
                    </li>
                </ul>
                <div class="tab-content">
                    <div class="tab-pane fade active in" id="tab_reversed_1_1">
                        <div class="table-container">
                            <table class="table table-striped table-bordered table-hover table-checkable" id="data_support">
                                <thead>
                                    <tr role="row" class="heading">
                                        ...
                                        <th width="2%"> # </th>
                                        <th width="15%"><?php echo $this->lang->line('global_support_name'); ?></th>
                    ...
                    <div class="tab-pane fade" id="tab_reversed_1_2">
                        <div class="table-container">
                            <table class="table table-striped table-bordered table-hover table-checkable" id="data_support_user">
                                <thead>
                                    <tr role="row" class="heading">
                                        <th width="2%">
                                            <div class="form-group form-md-checkboxes">
                                        ...
                                        <th width="15%"><?php echo $this->lang->line('global_support_code'); ?></th>
                                        <th width="15%"><?php echo $this->lang->line('global_support_name'); ?></th>
                                        <th width="15%"><?php echo $this->lang->line('global_email'); ?></th>
...
<!-- /.modal -->
<div id="import_user_support" class="modal">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <form id="import_file_support">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                            <a id="download_sample" data-filetype="xlsx" data-filename="sample_import_file_support" class="form-control-static"><i class="fa fa-cloud-download"></i></a>
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="exampleInputFile" class="col-md-3 control-label">Import Pengguna KSO (Vendor)</label>
                        <div class="col-md-9">
                            <input type="file" name="import_file_support" id="import_file_support" />
                            <p class="help-block">
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <form method="POST" id="frmVendor">
                ...
                <div class="modal-footer">
                    <input type="text" name="frm_support_id" hidden />
                    <input type="text" name="frm_support_user_id" hidden />
...
<div id="modal_add_edit_support_user" class="modal">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <form method="POST" id="frmVendorUser">
                <div class="modal-header">
                    <button type="button" class="close" data-action="close-modal" aria-hidden="true"></button>
                    <h4 class="modal-title" id="title_frm_support_user_mdl"></h4>
                </div>
                <div class="modal-body">
                    <div class="scroller" style="height:380px" data-always-visible="1" data-rail-visible1="1">
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group" id="div_support">
                                <label>Vendor</label>
                                <select class="form-control" name="support_list" id="support_list">
                ...
                <div class="modal-footer">
                    <input type="text" name="frm_support_user_id" hidden />
                    <input type="text" name="frm_support_user_user_id" hidden />
                    <button type="button" data-action="close-modal" class="btn dark btn-outline"><?php echo $this->lang->line('global_close'); ?></button>
                    <button type="submit" class="btn green"><?php echo $this->lang->line('global_save_changes'); ?></button>
                </div>
            </form>
