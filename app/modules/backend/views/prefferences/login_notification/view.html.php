                    ...
                    <table class="table table-striped table-bordered table-hover table-checkable" id="datatable_ajax">
                        <thead>
                            <tr role="row" class="heading">
                                ...
                                <th width="5%"> # </th>
                                <th width="15%"> Name </th>
                                <th width="35%"> Content Summary </th>
                                <th width="35%"> Content Full </th>
                    ...
                    <div class="scroller" style="height:300px" data-always-visible="1" data-rail-visible1="1">
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    <label class="control-label">Content Summary</label>
                                    <div class="input-icon right">
                                        <i class="fa fa-info-circle tooltips" data-container="body"></i>
                                        <input class="form-control" type="text" id="content_summary" name="content_summary" maxlength="30" />
                                        <span class="words">Maksimal Karakter 30</span> 
                                    </div>
                                </div>
                                <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" rows="3" id="content_full" name="content_full"></textarea>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group" style="height:30px">
                                    ...
                                    <input type="checkbox" class="make-switch" data-size="small" name="mdl_status"/>
                                </div>
                            </div>
                        </div>
                    </div>
