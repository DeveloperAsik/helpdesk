        ...
        return {
            ...
            init: function () {
                ...
                table = $('#datatable_ajax').DataTable({
                    ...
                    "ajax": {
                        url: base_backend_url + 'prefferences/email_config/get_list/',
                        type: 'POST'
                    },
                    "columns": [
                        {"data": "rowcheck"},
                ...
                $('#datatable_ajax').on('switchChange.bootstrapSwitch', 'input[name="status"]', function (event, state) {
                    ...
                    $.ajax({
                        url: base_backend_url + 'prefferences/email_config/update_status/' + Base64.encode(id),
                ...
                $("#opt_edit").on('click', function () {
                    ...
                    if (status_ == 0) {
                        ...
                        $.post(base_backend_url + 'prefferences/email_config/get_data/' + id, function (data) {
                ...
                $("#opt_delete").on('click', function () {
                    ...
                    if (status_ == 0) {
                        bootbox.confirm("Are you sure?", function (result) {
                            ...
                            $.ajax({
                                url: base_backend_url + 'prefferences/email_config/delete/' + Base64.encode(id),
                                method: "POST", //First change type to method here
                                data: formdata,
                                success: function (response) {
                ...
                $("#add_edit").submit(function () {
                    ...
                    var uri = base_backend_url + 'prefferences/email_config/insert/';
                    ...
                    if (id) {
                        uri = base_backend_url + 'prefferences/email_config/update/';
                        txt = 'update group';
                        formdata = {
                            id: Base64.encode(id),
                            keyword: keyword,
