                    ...
                    <table class="table table-striped table-bordered table-hover table-checkable" id="datatable_ajax">
                        <thead>
                            <tr role="row" class="heading">
                                ...
                                <th width="5%"> # </th>
                                <th width="15%"> <?php echo $this->lang->line('global_keyword'); ?> </th>
                                <th width="15%"> <?php echo $this->lang->line('global_value'); ?> </th>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label class="control-label"><?php echo $this->lang->line('global_keyword'); ?></label>
                                ...
                                <div class="form-group">
                                    <label class="control-label"><?php echo $this->lang->line('global_value'); ?></label>
                                    <div class="input-icon right">
                                        <i class="fa fa-info-circle tooltips" data-container="body"></i>
