                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="portlet box green">
                                <div class="portlet-title">
                                    <div class="caption">
                                        <i class="fa fa-gift"></i><?php echo $this->lang->line('global_detail_ticket'); ?> 
                                    </div>
                                    <div class="tools">
                                ...
                                <div class="portlet-body display-hide">
                                    <div class="scroller" style="height:420px" data-always-visible="1" data-rail-visible="1" data-rail-color="blue" data-handle-color="red">
                                        <div class="col-md-4">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-icon right">
                                                    ...
                                                    <input class="form-control problem_impact" type="text" name="create_by"  readonly=""/> 
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-8">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <textarea required class="form-control" rows="3" id="message" name="message" placeholder="Ketikkan pesan anda disini"></textarea>
                            </div>
                            <input type="text" name="job_id" id="job_id" hidden/>
                            <input type="text" name="ticket_id" id="ticket_id" hidden/>
                            <input type="text" name="ticket_code" id="ticket_code" hidden/>
                            <button type="submit" class="btn green" id="sbmt_message_chat"><?php echo $this->lang->line('global_submit'); ?></button>
                            <a class="btn red-mint" data-toggle="modal" data-id="<?php echo base64_encode($ticket['id'])?>" href="#modal_close" id="req_to_close"><?php echo $this->lang->line('global_ticket_close_btn'); ?></a>
                            <a class="btn red" data-toggle="modal" data-id="<?php echo base64_encode($ticket['id'])?>" id="req_to_transfer" href="#modal_transfer" title="Transfer">Transfer</a>
                        </div>
...
$this->load->view('includes/tools/img_view.html.php');
?>
