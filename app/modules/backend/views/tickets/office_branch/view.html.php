        ...
        <div class="portlet light portlet-fit portlet-datatable bordered">
            <div class="portlet-title">
                <div class="caption">
                    ...
                    <span class="caption-subject font-dark sbold uppercase"><?php echo $this->lang->line('global_immigration_list'); ?></span>
                </div>
                    ...
                    <table class="table table-striped table-bordered table-hover table-checkable" id="datatable_ajax">
                        <thead>
                            <tr role="row" class="heading">
                                ...
                                <th width="200"><?php echo $this->lang->line('global_address'); ?></th>
                                <th width="15%"><?php echo $this->lang->line('global_email'); ?></th>
                                <th width="15%"><?php echo $this->lang->line('global_zip_code'); ?></th>
                                <th width="200"><?php echo $this->lang->line('global_phone_number'); ?></th>								
                                <th width="15%"><?php echo $this->lang->line('global_fax'); ?></th>
                                <th width="15%"><?php echo $this->lang->line('global_status'); ?></th>
                                <th width="15%"><?php echo $this->lang->line('global_description'); ?></th>
                            </tr>							
                        </thead>
                        <tbody></tbody>
                    </table>
                        ...
                        <div class="row">
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label><?php echo $this->lang->line('global_type'); ?></label>
                                    <select class="form-control" name="type" id="type">
                                        <option><?php echo $this->lang->line('global_select_one'); ?></option>
                                        <?php if (isset($types) && !empty($types)): ?>
                                            <?php foreach ($types AS $key => $val): ?>
                                                <option value="<?php echo $val; ?>"><i class="fa <?php echo $val; ?>"></i><?php echo $val; ?></option>
                                            <?php endforeach; ?>
                                        <?php endif; ?>
                                    </select>
                                </div>	
                                ...
                                <div class="form-group">
                                    <label class="control-label"><?php echo $this->lang->line('global_zip_code'); ?></label>
                                    <div class="input-icon right">
                                        <i class="fa fa-info-circle tooltips" data-container="body"></i>
                            ...
                            <div class="col-md-3">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-icon right">
                                        <i class="fa fa-info-circle tooltips" data-container="body"></i>
                                        <input class="form-control" type="text" name="fax_number" /> 
                                    </div>
                                </div>
