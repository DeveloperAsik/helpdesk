        ...
        return {
            ...
            init: function () {
                var table = $('#datatable_ajax').DataTable({
                    ...
                    "ajax": {
                        url: base_backend_url + 'tickets/immigration_branch/get_list/',
                        type: 'POST'
                    },
                    "columns": [
                        {"data": "rowcheck"},
                ...
                $('a.btn').on('click', function () {
                    ...
                    switch (action) {
                        case 'add':
                            $('.modal-title').html('Insert New Imigration Branch');
                            break;
                        ...
                        case 'edit':
                            ...
                            if (status_ == 0) {
                                ...
                                $.ajax({
                                    url: base_backend_url + 'tickets/immigration_branch/get_data/',
                                    method: "POST", //First change type to method here
                                    data: formdata,
                                    success: function (response) {
