                ...
                <div class="table-container tbl_result">
                    <table class="table table-striped table-bordered table-hover table-checkable" id="datatable_ajax" hidden>
                        <thead>
                            <tr>
                                <th width="2%"> # </th>
                                <th width="5%"><?php echo $this->lang->line('global_code'); ?></th>
                                <th width="12%"><?php echo $this->lang->line('global_category'); ?></th>
                                <th width="15%"> Tag </th>
                                <th width="7%"><?php echo $this->lang->line('global_priority'); ?></th>
                                <th width="15%"><?php echo $this->lang->line('global_content'); ?></th>
                                <th width="10%"><?php echo $this->lang->line('global_create_by'); ?></th>
                                <th width="10%"><?php echo $this->lang->line('global_response_by'); ?></th>
                                <th width="8%"><?php echo $this->lang->line('global_create_date'); ?></th>
