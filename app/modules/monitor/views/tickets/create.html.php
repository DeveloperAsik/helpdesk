        ...
        <div class="portlet light bordered">
            <div class="portlet-title">
                ...
                <div class="portlet-body form">
                    <form class="issue_ticket_form" id="issue_ticket_form" role="form" style="padding-top:40px">
                        <div class="col-md-12">
                            <div class="form-body">
                                ...
                                <div class="form-group col-md-4 form-md-line-input form-md-floating-label has-info" id="main_category">
                                    <select name="category_1" class="form-control edited first_ctg" id="first_ctg" required>
                                ...
                                <div class="form-group col-md-4 form-md-line-input form-md-floating-label has-info" id="main_category">
                                    <select name="category_2" class="form-control edited second_ctg" id="second_ctg" required>
