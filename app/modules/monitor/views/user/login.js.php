    ...
    var Login = function () {
        ...
        var handleRegister = function () {
            function format(state) {
                ...
                var $state = $(
                        '<span><img src="' + static_url() + 'templates/metronics/assets/global/img/flags/' + state.element.value.toLowerCase() + '.png" class="img-flag" /> ' + state.text + '</span>'
                        );
