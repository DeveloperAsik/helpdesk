...
class Tickets extends MY_Controller {
    ...
    public function index() {
        redirect(base_backend_url('monitor/tickets/view/'));
    }
        ...
        if (isset($post) && !empty($post)) {
            ...
            if (isset($res) && !empty($res)) {
                ...
                foreach ($res as $d) {
                    ...
                    $data['action'] = ' <a class="btn red btn-outline sbold" data-toggle="modal" href="#modal_detail" title="Detail" data-id="' . base64_encode($d['id']) . '"> <i class="fa fa-search-plus"></i> </a>';
                    $arr[] = $data;
                    $i++;
                }
            }
